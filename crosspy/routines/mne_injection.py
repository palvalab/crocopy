...
from ..observables._base import NDArray, HAS_CUPY, get_module
...
_CONNECTIVITY_METHODS_MAP = {'cplv': lambda x: np.abs(compute_cplv),
...
mne.io.BaseRaw.compute_dfa = _compute_dfa_wrapper
mne.io.BaseRaw.compute_connectivity = _compute_connectivity_wrapper