...
def compute_phase_amplitude_coupling(data_low_frequency: NDArray[complex], data_high_frequency: NDArray[complex], low_frequency: float, sfreq: float=1000.0, omega: float=7.5) -> NDArray[complex]:
    """
    Computes phase-amplitude coupling between all channel pairs from two arrays, using the PLV-based method.
